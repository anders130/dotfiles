{
    flake.modules.homeManager.caelestia = {
        ...
        mkAutostartList = import ../../../lib/mkAutostartList.nix {inherit lib;};
    ...
    in {
        wayland.windowManager.hyprland.settings.exec-once =
            [(afterShellStarted "sleep 0.4 && hyprctl dispatch global caelestia:lock && mkdir -p /tmp/hyprland && touch /tmp/hyprland/first_lock_done")]
            ++ mkAutostartList afterFirstLogin config.my.caelestia.autostart;
    };
}
