...
in {
    ...
    home-manager.users.${username} = {
        ...
        xdg.configFile = {
            "fish/extraConfig.fish" = myLib.mkSymlink ./config.fish;
            "fish/functions" = myLib.mkSymlink ./functions;
            "fish/themes/fish.theme" = myLib.mkSymlink ./themes/fish.theme;
            "bat/themes/bat.tmTheme" = myLib.mkSymlink ./themes/bat.tmTheme;
            "fastfetch/shell-greeting.jsonc" = myLib.mkSymlink ./shell-greeting.jsonc;
        };
    };
