{
    flake-file.inputs.winapps.url = "github:winapps-org/winapps";
    den.aspects.winapps.nixos = {
        config,
        pkgs,
        inputs',
        ...
    ...
    in {
        nixpkgs.overlays = [(_: _: {inherit (inputs'.winapps.packages) winapps winapps-launcher;})];
